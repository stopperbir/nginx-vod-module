...
All code in this project is released under the [AGPLv3 license](http://www.gnu.org/licenses/agpl-3.0.jpg) unless a different license for a particular library is specified in the applicable library path. 
