...
* basename + extension - the set of options is packager specific (the list below applies to the default settings):
  ...
  * mss - manifest
  * thumb - `thumb-<offset>[<resizeparams>].html` (offset is the thumbnail video offset in milliseconds)
...
* resizeparams - can be used to resize the returned thumbnail image. For example, thumb-1000-w150-h100.html captures a thumbnail
...
The prefix of segment file names, the actual file name is `seg-<index>-v<video-track-index>-a<audio-track-index>.html`.
