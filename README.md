...
* basename + extension - the set of options is packager specific (the list below applies to the default settings):
  ...
  * mss - manifest
  * thumb - `thumb-<offset>[<resizeparams>].js` (offset is the thumbnail video offset in milliseconds)
...
* resizeparams - can be used to resize the returned thumbnail image. For example, thumb-1000-w150-h100.js captures a thumbnail
...
The prefix of segment file names, the actual file name is `seg-<index>-v<video-track-index>-a<audio-track-index>.js`.
...
All code in this project is released under the [AGPLv3 license](http://www.gnu.org/licenses/agpl-3.0.js) unless a different license for a particular library is specified in the applicable library path. 
